...
class Atoms:
    ...
    @property
    def s(self) -> NDArray[np.int64]: ...
    @s.setter
    def s(self, value: int | IntArray) -> None: ...
    @property
    def Z(self) -> NDArray[np.int64]: ...
    @Z.setter
    def Z(self, value: int | str | dict[str, int] | None) -> None: ...
    @property
    def Natoms(self) -> int: ...
    @property
    def Ns(self) -> NDArray[np.int64]: ...
    @property
    def Omega(self) -> float: ...
    @property
    def r(self) -> NDArray[np.float64]: ...
    @property
    def active(self) -> list[NDArray[np.bool_]]: ...
    @property
    def G(self) -> NDArray[np.float64]: ...
    @property
    def G2(self) -> NDArray[np.float64]: ...
    @property
    def G2c(self) -> NDArray[np.float64]: ...
    @property
    def Gk2(self) -> NDArray[np.float64]: ...
    @property
    def Gk2c(self) -> list[NDArray[np.float64]]: ...
    @property
    def Sf(self) -> NDArray[np.complex128]: ...
    @property
    def dV(self) -> float: ...
