...
def get_c(
    theta: ndarray, c1: float, c2: float, e1: float, e2: float, e3: float, e4: float, e5: float
) -> ndarray: ...
...
def get_dbdtheta(
    theta: ndarray, b1: float, b2: float, b3: float, b4: float, b5: float64
) -> ndarray: ...
def get_dcdtheta(
    theta: ndarray, c1: float, c2: float, e1: float, e2: float, e3: float, e4: float, e5: float
) -> ndarray: ...
def get_dddtheta(
    theta: ndarray, d1: float, d2: float, d3: float, d4: float, d5: float
) -> ndarray: ...
def get_dedtheta(
    theta: ndarray, e1: float, e2: float, e3: float, e4: float, e5: float
) -> ndarray: ...
def get_dfxc_zeta_paramsdrs(
    rs: ndarray, omega: float, a: ndarray, b: ndarray, c: ndarray, d: ndarray, e: ndarray
) -> ndarray: ...
...
def get_dfxcdndn_params(
    nup: ndarray, ndn: ndarray, T: float, p0: Parameters, p1: Parameters, p2: Parameters
) -> ndarray: ...
...
def get_dphidrs(rs: ndarray, theta: ndarray, zeta: ndarray, p: Parameters) -> ndarray: ...
def get_dphidtheta(rs: ndarray, theta: ndarray, zeta: ndarray, p: Parameters) -> ndarray: ...
def get_dphidzeta(rs: ndarray, theta: ndarray, zeta: ndarray, p: Parameters) -> ndarray: ...
...
def get_fxc(
    rs: ndarray, theta: ndarray, zeta: ndarray, p0: Parameters, p1: Parameters, p2: Parameters
) -> ndarray: ...
def get_fxc_nupndn(
    nup: ndarray, ndn: ndarray, T: float, p0: Parameters, p1: Parameters, p2: Parameters
) -> ndarray: ...
...
def get_phi(rs: ndarray, theta: ndarray, zeta: ndarray, p: Parameters) -> ndarray: ...
