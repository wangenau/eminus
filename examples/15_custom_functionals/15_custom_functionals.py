...
plt.plot(rs, functional_wrapper(rs, b) - ecp, label='Chachiyo')
plt.plot(rs, functional_wrapper(rs, 21.7392245) - ecp, label='Karasiev')
plt.plot(rs, functional_wrapper(rs, *fitted_b) - ecp, label='mod. Chachiyo')
plt.xlabel(r'$r_s$')
plt.ylabel(r'$E_c^\mathrm{P} - E_c^{\mathrm{P,QMC}}$ [$E_\mathrm{h}$]')
plt.legend()
