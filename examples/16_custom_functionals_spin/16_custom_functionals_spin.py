...
plt.plot(rs, lda_c_chachiyo_spin(n, 1, b0, b1) - ecf, label='Chachiyo')
plt.plot(rs, lda_c_chachiyo_spin(n, 1, 21.7392245, 28.3559732) - ecf, label='Karasiev')
plt.plot(rs, lda_c_chachiyo_spin(n, 1, fitted_b0, *fitted_b1) - ecf, label='mod. Chachiyo')
plt.xlabel(r'$r_s$')
plt.ylabel(r'$E_c^\mathrm{F} - E_c^{\mathrm{F,QMC}}$ [$E_\mathrm{h}$]')
plt.legend()
