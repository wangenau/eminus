...
Vdual = cJ(Vps * Sf)
W = randn(len(active[0]), 4) + 1j * randn(len(active[0]), 4)
W = orth(W)
W, Elist = sd(W, Vdual, 250)
W = orth(W)
W, Elist = pccg(W, Vdual, 250, 3)
...
print('4s-4p energy: %f (NIST: %f)' % (epsilon[0] - epsilon[1], 0.276641))
