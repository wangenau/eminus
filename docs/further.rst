...
- This thesis comes with an in-detail explanation of a minimalistic implementation called `SimpleDFT <https://gitlab.com/esp42/sage/simpledft>`_.
...
| To verify that changes work as intended, tests can be found in the `tests folder <https://gitlab.com/esp42/sage/eminus/-/tree/main/tests>`_.
...
| This code is lint-checked with `flake8 <https://flake8.pycqa.org>`_, using a custom `configuration file <https://gitlab.com/esp42/sage/eminus/-/tree/main/.flake8>`_.
